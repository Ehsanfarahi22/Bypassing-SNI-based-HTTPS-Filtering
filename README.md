...
# قدم بعدی
- همانطور که در<a href="https://0x00sec.org/t/bypassing-sni-filtering-feat-dpitunnel-zapret-and-geneva/31001"> این لینک </a>گفته شده است، برخی ISPها با بررسی پکت server hello نام سایت را به دست می آورند.
- راه حل فرگمنتت کردن server hello از سمت سرور است، اگر windiw size را در طی برقراری ارتباط کوچک نگه داریم، سرور این پکت را فرگمنت کرده و ارسال میکند.
